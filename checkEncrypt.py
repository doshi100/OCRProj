...
class textMarker:
    ...
    def ImageToData(img_address, is_table, orgImg=None, orgImg_coor=None):
        ...
        if(is_table):
            ...
            result = textMarker.OCR_correct(img)
            ...
            textMarker.strip_char(img_data)
            img_data["img_obj"] = img
            if(orgImg is not None):
    ...
    def OCR_wtextCorrect(img):
        img = textMarker.OCR_correct(img)
...
img_sourceList = []
img_compareList = []
img_compareList.append(textMarker.ImageToData('C:\\OCRProj\\bigPicture.jpeg', True, 'C:\\OCRProj\\nums.png', (0,259)))
img_sourceList.append(textMarker.ImageToData('C:\\OCRProj\\green2.png', True))
img_sourceList.append(textMarker.ImageToData('C:\\OCRProj\\greentable3.png', True))
img_sourceList.append(textMarker.ImageToData('C:\\OCRProj\\sourceta.png', True))
img_sourceList.append(textMarker.ImageToData('C:\\OCRProj\\whatsappImg.png', False))
img_sourceList.append(textMarker.ImageToData('C:\\OCRProj\\whatsappImg2.png', False))
textMarker.MarkWords(img_sourceList, img_compareList)
textMarker.cropPaste(img_sourceList, img_compareList)
textMarker.imgShow(img_sourceList, img_compareList)
